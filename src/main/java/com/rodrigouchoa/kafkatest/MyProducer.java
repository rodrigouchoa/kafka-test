...
/**
 * Our Producer. We will obtain Person objects from the repository
 * and then send them to the topic.
 * 
...
public class MyProducer {
	...
	/* Note that for testing 'personRepository' will be mocked. We don't want to test how these objects
	 * are obtained, just kafka. */
	...
	private void doSend(Person p) {
		...
		/* flushing for each send will make things inefficient. Without it, objects will be sent
		   in batches. See "queue.buffering.max.ms" */
