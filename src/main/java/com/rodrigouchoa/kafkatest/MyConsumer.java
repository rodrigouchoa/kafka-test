...
/**
 * Our consumer. Will use the PersonRepository to store the messages it
 * receives.
 * 
...
public class MyConsumer {
    ...
    @KafkaListener(topics = "#{__listener.props.topic}", groupId = "#{__listener.props.consumer.groupId}")
